...
class Encoder_RNNSearch(nn.Module):
    def __init__(self, input_size, emb_size, enc_hid_size, dec_hid_size, dropout_proba):
        super().__init__()       
        self.embedding = nn.Embedding(input_size, emb_size)
...
class Decoder_RNNSearch(nn.Module):
    def __init__(self, output_size, emb_size, enc_hidden_size, dec_hidden_size, dropout_proba, attention):
        super().__init__()
